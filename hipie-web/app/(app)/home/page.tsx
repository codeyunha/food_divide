  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mb-10 flex items-center gap-4">
        ...
        <div>
          <h2 className="text-[26px] font-bold text-[var(--ink)]">
            {nickname}님, 반가워요! 👋
          </h2>
...
function SelectCard({
  ...
  return (
    <Link
      href={href}
      className="group relative flex flex-col overflow-hidden rounded-3xl border border-[var(--line)] bg-white p-8 transition hover:-translate-y-1 hover:shadow-xl"
    >
      <div
        className="absolute right-0 top-0 h-32 w-32 translate-x-8 -translate-y-8 rounded-full opacity-10 transition group-hover:opacity-20"
